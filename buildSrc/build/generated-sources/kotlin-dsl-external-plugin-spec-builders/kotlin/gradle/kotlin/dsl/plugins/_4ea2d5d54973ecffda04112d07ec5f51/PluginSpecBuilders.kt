...
package gradle.kotlin.dsl.plugins._4ea2d5d54973ecffda04112d07ec5f51
...
/**
 * The `com.google.dagger` plugin group.
 */
@org.gradle.api.Generated
internal
class `ComGoogleDaggerPluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `com.google.dagger`.
 */
internal
val `ComGooglePluginGroup`.`dagger`: `ComGoogleDaggerPluginGroup`
    get() = `ComGoogleDaggerPluginGroup`(plugins)


/**
 * The `com.google.dagger.hilt` plugin group.
 */
@org.gradle.api.Generated
internal
class `ComGoogleDaggerHiltPluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `com.google.dagger.hilt`.
 */
internal
val `ComGoogleDaggerPluginGroup`.`hilt`: `ComGoogleDaggerHiltPluginGroup`
    get() = `ComGoogleDaggerHiltPluginGroup`(plugins)


/**
 * The `com.google.dagger.hilt.android` plugin implemented by [dagger.hilt.android.plugin.HiltGradlePlugin].
 */
internal
val `ComGoogleDaggerHiltPluginGroup`.`android`: PluginDependencySpec
    get() = plugins.id("com.google.dagger.hilt.android")


/**
 * The `dagger` plugin group.
 */
@org.gradle.api.Generated
internal
class `DaggerPluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `dagger`.
 */
internal
val `PluginDependenciesSpec`.`dagger`: `DaggerPluginGroup`
    get() = `DaggerPluginGroup`(this)


/**
 * The `dagger.hilt` plugin group.
 */
@org.gradle.api.Generated
internal
class `DaggerHiltPluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `dagger.hilt`.
 */
internal
val `DaggerPluginGroup`.`hilt`: `DaggerHiltPluginGroup`
    get() = `DaggerHiltPluginGroup`(plugins)


/**
 * The `dagger.hilt.android` plugin group.
 */
@org.gradle.api.Generated
internal
class `DaggerHiltAndroidPluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `dagger.hilt.android`.
 */
internal
val `DaggerHiltPluginGroup`.`android`: `DaggerHiltAndroidPluginGroup`
    get() = `DaggerHiltAndroidPluginGroup`(plugins)


/**
 * The `dagger.hilt.android.plugin` plugin implemented by [dagger.hilt.android.plugin.HiltGradlePlugin].
 */
internal
val `DaggerHiltAndroidPluginGroup`.`plugin`: PluginDependencySpec
    get() = plugins.id("dagger.hilt.android.plugin")
